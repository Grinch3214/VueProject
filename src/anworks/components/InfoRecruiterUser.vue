      ...
      <b-row class="mb-1">
        ...
        >
          ...
          >
            <b-form-input
              id="register-date"
              v-model="recruiterInfo.registerDate"
      ...
      <b-row>
        ...
        >
          ...
          >
            <b-form-input
              id="spend"
              v-model="recruiterInfo.spend"
              placeholder="Лимит трат"
            />
          </b-form-group>
        </b-col>
